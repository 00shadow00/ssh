...
read -p "Database Name    : " -e -i Radz NamaDatabase
echo "Input MySQL Password:"
echo "(Use different Password for your database, dont use VPS password.)"
read -p "Database Password: " -e -i Radzer PasswordDatabase
echo ""
...
if [ "$OS" == "x86_64" ]; then
  wget https://raw.githubusercontent.com/00shadow00/ssh/master/rpmforge-release-0.5.3-1.el6.rf.x86_64.rpm
  rpm -Uvh rpmforge-release-0.5.3-1.el6.rf.x86_64.rpm
else
  wget https://raw.githubusercontent.com/00shadow00/ssh/master/rpmforge-release-0.5.3-1.el6.rf.i686.rpm
...
wget -O /etc/nginx/nginx.conf "https://raw.githubusercontent.com/00shadow00/ssh/master/nginx.conf"
wget -O /etc/nginx/conf.d/vps.conf "https://raw.githubusercontent.com/00shadow00/ssh/master/vps.conf"
...
# install screenfetch
cd
wget -O /usr/bin/screenfetch "https://raw.githubusercontent.com/00shadow00/ssh/master/screenfetch"
chmod +x /usr/bin/screenfetch
echo "clear" >> .bash_profile
echo "screenfetch" >> .bash_profile

# install openvpn
wget -O /etc/openvpn/openvpn.tar "https://raw.githubusercontent.com/00shadow00/ssh/master/centos6/openvpn-debian.tar"
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://raw.githubusercontent.com/00shadow00/ssh/master/centos6/1194-centos.conf"
if [ "$OS" == "x86_64" ]; then
  wget -O /etc/openvpn/1194.conf "https://raw.githubusercontent.com/00shadow00/ssh/master/centos6/1194-centos64.conf"
fi
wget -O /etc/iptables.up.rules "https://raw.githubusercontent.com/00shadow00/ssh/master/centos6/iptables.up.rules"
...
cd /etc/openvpn/
wget -O /etc/openvpn/1194-client.ovpn "https://raw.githubusercontent.com/00shadow00/ssh/master/centos6/open-vpn.conf"
...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/00shadow00/ssh/master/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/00shadow00/ssh/master/badvpn-udpgw64"
fi
...
# setting banner
rm /etc/issue.net
wget -O /etc/issue.net "https://raw.githubusercontent.com/00shadow00/ssh/master/issue.net"
...
# install mrtg
cd /etc/snmp/
wget -O /etc/snmp/snmpd.conf "https://raw.githubusercontent.com/00shadow00/ssh/master/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://raw.githubusercontent.com/00shadow00/ssh/master/mrtg-mem.sh"
...
curl "https://raw.githubusercontent.com/00shadow00/ssh/master/mrtg.conf" >> /etc/mrtg.cfg
...
# install vnstat gui
cd /home/vps/public_html/
wget https://raw.githubusercontent.com/00shadow00/ssh/master/vnstat_php_frontend-1.5.1.tar.gz
...
# install stunnel
yum install stunnel
#wget -O /etc/pki/tls/certs/stunnel.pem "https://raw.githubusercontent.com/00shadow00/ssh/master/updates/stunnel.pem"
#wget -O /etc/stunnel/stunnel.conf "https://raw.githubusercontent.com/00shadow00/ssh/master/updates/stunnel.conf"
...
# download script
cd
wget https://raw.githubusercontent.com/00shadow00/ssh/master/updates/install-premiumscripts.sh -O - -o /dev/null|sh
...
echo "               Created By Dark Cry(fb.com/mhuradz)                 "
echo "                              Modified by Dark Cry                              "
echo "--------------------------------------------------------------------------------"
...
echo "Script Created By Dark Cry(fb.com/mhuradz)"   		| tee -a log-install-ocspanel.txt
echo "Modified by Dark Cry"                      	                 	| tee -a log-install-ocspanel.txt
echo "--------------------------------------------------------------------------------"| tee -a log-install-ocspanel.txt
echo ""
echo ""
cd
