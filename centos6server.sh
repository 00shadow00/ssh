...
# install openvpn
wget -O /etc/openvpn/openvpn.tar "https://raw.githubusercontent.com/00shadow00/ssh/master/openvpn-debian.tar"
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://raw.githubusercontent.com/00shadow00/ssh/master/1194-centos.conf"
if [ "$OS" == "x86_64" ]; then
  wget -O /etc/openvpn/1194.conf "https://raw.githubusercontent.com/00shadow00/ssh/master/1194-centos64.conf"
fi
wget -O /etc/iptables.up.rules "https://raw.githubusercontent.com/00shadow00/ssh/master/iptables.up.rules"
...
# install stunnel
#yum install stunnel
#wget -O /etc/pki/tls/certs/stunnel.pem "https://raw.githubusercontent.com/00shadow00/ssh/master/stunnel.pem"
#wget -O /etc/stunnel/stunnel.conf "https://raw.githubusercontent.com/00shadow00/ssh/master/stunnel.conf"
...
# download script
cd
wget https://raw.githubusercontent.com/00shadow00/ssh/master/install-premiumscripts.sh -O - -o /dev/null|sh
...
echo "                         Copyright FastSurfing VPN 2019                                 "
echo "                              Made with 💖 by Dark Cry                            "
echo "--------------------------------------------------------------------------------"
...
echo ""  | tee -a log-install.txt
echo "------------------------------ Made with Love by Dark Cry -----------------------------"
